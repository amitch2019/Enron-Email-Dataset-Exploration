...
This project leverages data science techniques to analyze the Enron email dataset, aiming to uncover insights from the communications of Enron executives. The project demonstrates proficiency in data preprocessing, natural language processing (NLP), and network analysis, providing a comprehensive analysis of the email corpus.
